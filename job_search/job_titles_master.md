<!-- # 🎯 Target Job Titles (Structured for Future Automation) -->

## Core / Transferable Roles
...
- Monitoring & Controls Engineer
- Field Systems Integration Specialist
- Environmental Systems Analyst

## Cloud / Infrastructure Pathways
- Cloud Operations Engineer
- Cloud Support Associate
- Infrastructure Analyst
- Systems Reliability Analyst
- Infrastructure-as-Code (IaC) Associate

## Cross-Functional / Bridge Roles
- Technical Project Specialist / Coordinator
